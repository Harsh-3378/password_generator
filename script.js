...
function shufflePassword(shufflePassword){
    for (let i = shufflePassword.length -1; i>0; i--){
        ...
        const tem = shufflePassword[i];
        shufflePassword[i] = shufflePassword[j];
        shufflePassword[j] = tem;
    }
...
allCheckBox.forEach((checkbox)=>{
    checkbox.addEventListener('change',handleCeckBoxChange)
})
...
generateBtn.addEventListener('click',()=>{
    //none of the ceckbox ar selected
